        ...
        <div className="bg-card border border-card-border rounded-2xl p-6 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              disabled={isSubmitting}
              className="w-full px-4 py-3 bg-foreground text-background rounded-xl font-medium hover:opacity-90 transition-opacity cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isSubmitting
                ? "Loading..."
                : mode === "signin"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-foreground/10 text-foreground rounded-xl font-medium hover:bg-foreground/20 transition-colors cursor-pointer"
          >
