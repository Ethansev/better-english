    ...
    <div className="relative">
      ...
      {showDropdown && (
        <>
          ...
          />
          <div className="absolute right-0 mt-2 w-48 bg-card border border-card-border rounded-lg shadow-lg z-20 overflow-hidden">
            <button
              onClick={() => {
            ...
            <button
              ...
              className="w-full px-4 py-3 text-left text-sm hover:bg-foreground/5 transition-colors flex items-center gap-3 border-t border-card-border"
            >
